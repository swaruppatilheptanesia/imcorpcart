...
export const mappingRows = [
  ...
  { csv: 'hsn_code', field: 'products.hsn_code' },
  { csv: 'gst_percent', field: 'products.gst_percent (%)' },
  { csv: 'terms_text', field: 'products.terms_text (T&C)' },
  { csv: 'warranty_text', field: 'products.warranty_text' },
